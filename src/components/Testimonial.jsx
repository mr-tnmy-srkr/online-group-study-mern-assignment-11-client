...
const Testimonial = () => {
  return (
    <div>
      ...
      <h1 className="text-2xl text-center -mt-7 mb-4 dark:text-white">{`Student's feedback`}</h1>
          ...
          <section className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 lg:grid-cols-2 xl:grid-cols-3">
            <div className="p-8 border rounded-lg dark:border-gray-700">
              <p className="leading-loose text-gray-500 dark:text-gray-400">
                “consectetur adipisicing elit. Tempore quibusdam ducimus libero
                ad tempora doloribus expedita laborum saepe voluptas perferendis
                delectus assumenda rerum, culpa aperiam dolorum, obcaecati
                corrupti aspernatur a.”.
              </p>
            ...
            <div className="p-8 bg-blue-500 border border-transparent rounded-lg dark:bg-blue-600">
              ...
              <div className="flex items-center mt-8 -mx-2">
                ...
                <div className="mx-2">
                  ...
                  <span className="text-sm text-blue-200">Ex-Student</span>
                </div>
              </div>
            </div>
